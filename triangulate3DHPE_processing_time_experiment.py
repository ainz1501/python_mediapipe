...
entire_time = Landmark_detect_time+Normalized_to_screen_coord_time+Projection_mat_calc_time+Triangulate_3Dpoint_time-(4*print_times_time)
print("entire culc:", entire_time)
